...
public class CameraLibConfig {
    ...
    private static final ForgeConfigSpec.DoubleValue ORTHOGRAPHIC_ZOOM_MULTIPLIER;
    private static final ForgeConfigSpec.BooleanValue LOCK_ORTHOGRAPHIC_PITCH;
